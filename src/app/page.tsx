...
const BountyPlatform = () => {
  ...
  return (
    ...
    <nav className="flex flex-col sm:flex-row justify-between items-center p-4 sm:mb-12 sm:ml-12 sm:mt-4 sm:mr-6 gap-4">
      ...
      <Link href="/"><Image src="/Group.png" alt="logo" height={30} width={30} /></Link>
      </div>
      ...
      <div className="w-full mx-0 px-0 relative">
        <div className="w-full">
          <h1 className="text-xl md:text-3xl font-bold text-white mb-4 leading-tight text-left">
            Maybe the real DApps were friends <br className="hidden sm:block" /> we made all along
          </h1>
    ...
    {/* Search and Filter Section - Made responsive */}
    <div className="max-w-8xl mx-2 sm:mx-[35px] px-0 py-4 sm:py-8">
      <div className="flex flex-col sm:flex-row gap-4 mb-8 sm:mb-12 items-stretch sm:items-center">
        <div className="relative flex-1 flex items-center border border-gray-700 rounded-lg">
          ...
          />
          <span className="absolute right-3 text-gray-400 hidden sm:block">⌘K</span>
        </div>
            ...
            <div className="space-y-4 sm:space-y-6">
              {[1, 2, 3].map((item) => (
                ...
                >
                  ...
                  <div className="my-4" style={{ borderTop: "2px dotted #3A3A3A" }}></div>
    ...
    <div className="fixed inset-0 w-full flex justify-center items-start z-50">
      <div className="bg-[#1A1A1A] rounded-lg relative w-full max-w-7xl h-[90vh] mt-8 mx-4 overflow-hidden">
        ...
        >
          ...
          {/* Recent Submissions - Made responsive */}
          <div className="mt-6 lg:mt-0">
            <h2 className="text-xl font-bold text-white mb-4 sm:mb-6">Recent Submissions</h2>
            <div className="space-y-3 sm:space-y-4">
              {[1, 2, 3, 4, 5].map((item) => (
                <div key={item} className="bg-[#1A1A1A] rounded-lg p-3 sm:p-4 flex items-center gap-3 sm:gap-4">
                  <Image
                    src="/fre"
                    alt="Avatar"
                    width={40}
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-white font-medium truncate">Niko Shestov</h3>
                    <p className="text-gray-400 text-sm truncate">XYZ Bounty Challenge</p>
                  </div>
                  <span className="text-gray-500 text-sm whitespace-nowrap">20 mins ago</span>
                </div>
              ))}
            </div>
          </div>
