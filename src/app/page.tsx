...
import { Search, ChevronDown, Flame, ChevronUp } from 'lucide-react';
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex space-x-6">
          ...
          <div className="flex gap-2">
            <span className="px-3 py-2 rounded-full text-sm bg-yellow-500/20 text-yellow-500">
              DeFi
            </span>
            <span className="px-3 py-2 rounded-full text-sm bg-purple-500/20 text-purple-500">
              Gaming
            </span>
          </div>
        </div>
        <div className="flex items-center gap-2 bg-[#1A1A1A] px-4 py-2 rounded-lg">
          <span className="flex"><Image src="/Img_margin.png" alt="ton-currency-logo" height={0} width={15} />40k</span>
